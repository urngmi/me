...
const Outlook = () => {
  ...
  const FROM_EMAIL = "feedback@bhor.online";
  const TO_EMAIL = process.env.NEXT_PUBLIC_ADMIN_EMAIL; // TODO: SET YOUR EMAIL IN .env.local
  ...
  const sendEmail = async () => {
    ...
    try {
      await axios({
        method: "post",
        url: `https://api.mailgun.net/v3/bhor.online/messages`,
        auth: {
          username: "api",
          password: API_KEY,
        },
        ...
        <div className={styles.mailing}>
          ...
          <div className={styles.mailing_fields}>
            <input
              ...
              id="text21"
              type="text"
              value="Omkar Bhor (omkarbhor4011@gmail.com)"
            />
            <input
              className={styles.textfield}
              ref={emailRef}
